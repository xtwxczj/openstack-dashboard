  ...
  function update_launch_source_displayed_fields (field) {
    ...
    switch(base_type) {
      ...
      case "volume_snapshot_id":
        ...
        break;
    case "img_for_testing_id":
      // $("#id_img_for_testing_id").closest(".control-group").show();
      // $("#id_image_id").val($("#id_img_for_testing_id").val());
      
	 elements_list = "#id_img_for_testing_id";
	 break;
        case "img_for_testing_public_ip_id":
	  elements_list = "#id_img_for_testing_public_ip_id";
        //    $("#id_img_for_testing_public_ip_id").closest(".control-group").show();
        //    $("#id_image_id").val($("#id_img_for_testing_public_ip_id").val());
            break;
        case "img_for_login_node_id":
	  elements_list = "#id_img_for_login_node_id,#id_afs_username,#id_afs_password";
        //    $("#id_img_for_login_node_id").closest(".control-group").show();
        //    $("#id_afs_username").closest(".control-group").show();
        //    $("#id_afs_password").closest(".control-group").show();
        //    $("#id_image_id").val($("#id_img_for_login_node_id").val());
            break;
        case "img_for_login_node_public_ip_id":
	   elements_list = "#id_img_for_login_node_public_ip_id,#id_afs_username,#id_afs_password";
        //    $("#id_img_for_login_node_public_ip_id").closest(".control-group").show();
        //    $("#id_afs_username").closest(".control-group").show();
        //    $("#id_afs_password").closest(".control-group").show();
        //    $("#id_image_id").val($("#id_img_for_login_node_public_ip_id").val());
            break;
...
function update_afs_check_displayed_fields(field) {
           var $this = $(field);
           var base_type = $this.val();
           var elements_list;
	...
	switch (base_type) {
        case "testing":
           // $("#id_img_for_testing_id").closest(".control-group").show();
           $("#id_source_type").val($("#id_img_for_testing_id").val());
	   elements_list = "#id_img_for_testing_id";
        break;
        case "testing_public_ip":
	    elements_list = "#id_img_for_testing_public_ip_id";
            //    $("#id_img_for_testing_public_ip_id").closest(".control-group").show();
            $("#id_image_id").val($("#id_img_for_testing_public_ip_id").val());
            break;
	   ...
	   elements_list = "#id_img_for_login_node_public_ip_id,#id_afs_username,#id_afs_password";
        ...
        //    $("#id_afs_password").closest(".control-group").show();
            ...
            break;
       case "custom":
            $("#id_source_type").closest(".form-group").show();
            break;
        }
      var elements_list_group = $(elements_list).closest(".form-group");
      elements_list_group.show();
    ...
    $(document).on('change', '.workflow #id_vm_type', function(evt) {
        update_afs_check_displayed_fields(this);
       //update_launch_source_displayed_fields(this);
    });
    $('.workflow #id_vm_type').change();
    horizon.modals.addModalInitFunction(function(modal) {
        $(modal).find("#id_vm_type").change();
   });
  ...
  function update_image_id_fields(field) {
   ...
   switch(base_type) {
    ...
    case "img_for_testing_id":
	 elements_list = "#id_image_id";
       $("#id_img_for_testing_id").closest(".form-group").show();
       $("#id_image_id").val($("#id_img_for_testing_id").val());
       elements_list = "#id_image_id";
	break;
        case "img_for_testing_public_ip_id":
	  elements_list = "#id_image_id";
            $("#id_img_for_testing_public_ip_id").closest(".form-group").show();
            $("#id_image_id").val($("#id_img_for_testing_public_ip_id").val());
	 elements_list = "#id_image_id";
	break;
        case "img_for_login_node_id":
	  elements_list = "#id_image_id,#id_afs_username,#id_afs_password";
            $("#id_img_for_login_node_id").closest(".form-group").show();
        //    $("#id_afs_username").closest(".control-group").show();
        //    $("#id_afs_password").closest(".control-group").show();
            $("#id_image_id").val($("#id_img_for_login_node_id").val());
	...
	break;
        case "img_for_login_node_public_ip_id":
	   elements_list = "#id_image_id,#id_afs_username,#id_afs_password";
            $("#id_img_for_login_node_public_ip_id").closest(".form-group").show();
        //    $("#id_afs_username").closest(".control-group").show();
        //    $("#id_afs_password").closest(".control-group").show();
            $("#id_image_id").val($("#id_img_for_login_node_public_ip_id").val());
    ...
    $(document).on('change', '.workflow #id_img_for_testing_id', function(evt) {
        update_image_id_fields(this);
    });
    $(document).on('change', '.workflow #id_img_for_testing_public_ip_id', function(evt) {
        update_image_id_fields(this);
    });
    $(document).on('change', '.workflow #id_img_for_login_node_id', function(evt) {
        update_image_id_fields(this);
    });
    $(document).on('change', '.workflow #id_img_for_login_node_public_ip_id', function(evt) {
        update_image_id_fields(this);
    });
/*
    $document.on('change', '.workflow #id_source_type', function (evt) {
